<?php
$section_1_top_description =  get_field('section_1_top_description');
$section_1_right_description =  get_field('section_1_right_description');
$section_1_image =  get_field('section_1_image');
?>
<section class="ourngura-section1 padding-vertical programs-main">
    <div class="nyamal-container">
        <div class="inner">
            <div class="description body24">
                <?php echo $section_1_top_description?>
            </div>
            <div class="two-cols">
                <img src="<?php echo $section_1_image ?>">
                <div class="description body19">
                    <?php echo $section_1_right_description?>
                </div>
...
<section class="story-nyamal-people programs">
        ...
        <div class="inner">
            <div class="programs-grid">
                <?php foreach ($programs_list as $program) :?>
                    <a class="program" href="<?php echo $program['page'] ?>">
